...
function appendData (tableId, objectLocation, callback) {

    console.log('append data: '+tableId+ ' loc: '+objectLocation);

    var options = {
        method: 'POST',
        url: 'http://54.186.74.126:8080/table/appendData?tableId='+tableId+'&objectName='+objectLocation
    };
...
function upsertTable(tableData, callback) {
    ...
    getTables( function (currentTables) {
        ...
        for (var i = 0; i < currentTables.length; i++) {
            console.log('test current tables: '+currentTables[i]);
...
function createTable (tableData, callback) {
    ...
    var options = { method: 'POST',
        url: 'http://54.186.74.126:8080/table/create',
...
function updateTable (tableId, tableData, callback) {
    ...
    var options = { method: 'POST',
        url: 'http://54.186.74.126:8080/table/show/tableId',
        body: JSON.stringify(tableData)
    };
...
function getTables( callback) {
    ...
    var options = { method: 'GET',
      url: 'http://54.186.74.126:8080/table'
  };
